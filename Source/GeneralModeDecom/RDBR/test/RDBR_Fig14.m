...
if (1)
    ...
    if (1)
        ...
        for cnt = 1:2
            ...
            tit = sprintf('fig14_%d.fig',8+cnt-1);
            saveas(pic,tit);
            str = sprintf('./results/RDBR_fig14_%d',8+cnt-1);
            print(gcf, '-depsc', str);
            ...
            b=get(gca);
            set(b.XLabel, 'FontSize', 16);set(b.YLabel, 'FontSize', 16);set(b.ZLabel, 'FontSize', 16);set(b.Title, 'FontSize', 16);
            tit = sprintf('fig14_%d.fig',10+cnt-1);
            saveas(pic,tit);
            str = sprintf('./results/RDBR_fig14_%d',10+cnt-1);
            print(gcf, '-depsc', str);
        end
    ...
    save ./results/RDBR_fig14.mat;
end

if (1)
    load ./results/RDBR_fig14.mat;
    close all;
    ...
    for i = 1:num_group
        ...
        b=get(gca);
        set(b.XLabel, 'FontSize', 16);set(b.YLabel, 'FontSize', 16);set(b.ZLabel, 'FontSize', 16);set(b.Title, 'FontSize', 16);
        tit = sprintf('./results/RDBR_fig14_%d.fig',i);
        saveas(pic,tit);
        str = sprintf('./results/RDBR_fig14_%d',i);
        print(gcf, '-depsc', str);
    end
end
