...
if (1)
    ...
    if (0)
        ...
        tit = sprintf('./results/RDBR_fig12_9.fig',i+4);
        saveas(pic,tit);
        str = sprintf('./results/RDBR_fig12_9');
        print(gcf, '-depsc', str);
    end
    ...
    opt.show = 0;
    opt.nknots = 20;
    opt.knotremoval_factor= 1.001;%1.0001 is fine
    opt.order = 3;
    ...
    save ./results/RDBR_fig12ns.mat;
end


if (1)
    load ./results/RDBR_fig12ns.mat;
    %%
    ...
    for i = 1:num_group
        ...
        b=get(gca);
        set(b.XLabel, 'FontSize', 16);set(b.YLabel, 'FontSize', 16);set(b.ZLabel, 'FontSize', 16);set(b.Title, 'FontSize', 16);
        tit = sprintf('./results/RDBR_fig12_%d.fig',i+4);
        saveas(pic,tit);
        str = sprintf('./results/RDBR_fig12_%d',i+4);
        print(gcf, '-depsc', str);
    end
end
