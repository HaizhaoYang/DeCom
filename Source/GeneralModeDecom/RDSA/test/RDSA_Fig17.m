% This code generates Figure 17-19 of the paper
%
...
if (1)
    ...
    saveas(pic,'./results/RDSA_fig_cross_truecomp1_1.fig');
    set(gca, 'FontSize', 16);
    b=get(gca);
    set(b.XLabel, 'FontSize', 16);set(b.YLabel, 'FontSize', 16);set(b.ZLabel, 'FontSize', 16);set(b.Title, 'FontSize', 16);
    str = './results/RDSA_fig_cross_truecomp1_1';
    ...
    pbaspect([10 1 1]); set(pic, 'Position', [200, 200, 1200, 200]);
    saveas(pic,'./results/RDSA_fig_cross_truecomp2_1.fig');
    set(gca, 'FontSize', 16);
    b=get(gca);
    set(b.XLabel, 'FontSize', 16);set(b.YLabel, 'FontSize', 16);set(b.ZLabel, 'FontSize', 16);set(b.Title, 'FontSize', 16);
    str = './results/RDSA_fig_cross_truecomp2_1';
    print(gcf, '-depsc', str);      command = sprintf('epstopdf %s.eps',str);      system(command);
    
    pic = figure;
    plot(x(N1:N2),a1sin(N1:N2).*sh1(F1*xx(N1:N2)),'b'); axis tight; xlabel('time');ylabel('signal intensity');
    pbaspect([10 1 1]); set(pic, 'Position', [200, 200, 1200, 200]);
    saveas(pic,'./results/RDSA_fig_cross_truecompsin1_2.fig');
    set(gca, 'FontSize', 16);
    b=get(gca);
    set(b.XLabel, 'FontSize', 16);set(b.YLabel, 'FontSize', 16);set(b.ZLabel, 'FontSize', 16);set(b.Title, 'FontSize', 16);
    str = './results/RDSA_fig_cross_truecompsin1_1';
    print(gcf, '-depsc', str);      command = sprintf('epstopdf %s.eps',str);      system(command);
    ...
    pbaspect([10 1 1]); set(pic, 'Position', [200, 200, 1200, 200]);
    saveas(pic,'./results/RDSA_fig_cross_truecompcos2_2.fig');
    set(gca, 'FontSize', 16);
    b=get(gca);
    set(b.XLabel, 'FontSize', 16);set(b.YLabel, 'FontSize', 16);set(b.ZLabel, 'FontSize', 16);set(b.Title, 'FontSize', 16);
    str = './results/RDSA_fig_cross_truecompcos2_1';
    print(gcf, '-depsc', str);      command = sprintf('epstopdf %s.eps',str);      system(command);
    ...
    pbaspect([10 1 1]); set(pic, 'Position', [200, 200, 1200, 200]);
    saveas(pic,'./results/RDSA_fig_cross_truecompcos1_2.fig');
    set(gca, 'FontSize', 16);
    b=get(gca);
    set(b.XLabel, 'FontSize', 16);set(b.YLabel, 'FontSize', 16);set(b.ZLabel, 'FontSize', 16);set(b.Title, 'FontSize', 16);
    str = './results/RDSA_fig_cross_truecompcos1_1';
    print(gcf, '-depsc', str);      command = sprintf('epstopdf %s.eps',str);      system(command);
    ...
    pbaspect([10 1 1]); set(pic, 'Position', [200, 200, 1200, 200]);
    saveas(pic,'./results/RDSA_fig_cross_truecompsin2_2.fig');
    set(gca, 'FontSize', 16);
    b=get(gca);
    set(b.XLabel, 'FontSize', 16);set(b.YLabel, 'FontSize', 16);set(b.ZLabel, 'FontSize', 16);set(b.Title, 'FontSize', 16);
    str = './results/RDSA_fig_cross_truecompsin2_1';
    print(gcf, '-depsc', str);      command = sprintf('epstopdf %s.eps',str);      system(command);
    ...
    opt.name = './results/RDSA_fig_cross_reconcomp';
    opt.numSweep = 10;
    ...
    save('./results/RDSA_fig_cross.mat','-v7.3');
end

if (1)
    load ./results/RDSA_fig_cross.mat;
    ...
    for cnt = 1:numGroup
        ...
        tit = sprintf('./results/RDSA_fig_cross_%d_shape_%d.fig',cnt,0);
        saveas(pic,tit);
        str = sprintf('./results/RDSA_fig_cross_%d_shape_%d',cnt,0);
        print(gcf, '-depsc', str);   command = sprintf('epstopdf %s.eps',str);      system(command);
        
        e1 = norm(shape{cnt}.s0*Hcoef{cnt}.a0-Tcoef{cnt}.a0*shapeTrue{cnt}(linspace(0,1,LL))/sqrt(sum(abs(shapeTrue{cnt}(linspace(0,1,LL))).^2)/LL))/sqrt(length(shape{cnt}.s0*Hcoef{cnt}.a0))
        ...
        b=get(gca);
        set(b.XLabel, 'FontSize', 32);set(b.YLabel, 'FontSize', 32);set(b.ZLabel, 'FontSize', 32);set(b.Title, 'FontSize', 32);
        tit = sprintf('./results/RDSA_fig_cross_%d_shapeCn_%d.fig',cnt,1);
        saveas(pic,tit);
        str = sprintf('./results/RDSA_fig_cross_%d_shapeCn_%d',cnt,1);
        print(gcf, '-depsc', str);   command = sprintf('epstopdf %s.eps',str);      system(command);
        
        norm(shape{cnt}.scn{1}*Hcoef{cnt}.a(1)-Tcoef{cnt}.a(1)*shapeTrue{cnt}(linspace(0,1,LL))/sqrt(sum(abs(shapeTrue{cnt}(linspace(0,1,LL))).^2)/LL))/sqrt(length(shape{cnt}.scn{1}*Hcoef{cnt}.a(1)))
        ...
        b=get(gca);
        set(b.XLabel, 'FontSize', 32);set(b.YLabel, 'FontSize', 32);set(b.ZLabel, 'FontSize', 32);set(b.Title, 'FontSize', 32);
        tit = sprintf('./results/RDSA_fig_cross_%d_shapeSn_%d.fig',cnt,1);
        saveas(pic,tit);
        str = sprintf('./results/RDSA_fig_cross_%d_shapeSn_%d',cnt,1);
        print(gcf, '-depsc', str);   command = sprintf('epstopdf %s.eps',str);      system(command);
        
        norm(shape{cnt}.ssn{1}*Hcoef{cnt}.b(1)-Tcoef{cnt}.b(1)*shapeTrue{cnt}(linspace(0,1,LL))/sqrt(sum(abs(shapeTrue{cnt}(linspace(0,1,LL))).^2)/LL))/sqrt(length(shape{cnt}.ssn{1}*Hcoef{cnt}.b(1)))
        ...
        norm(shape{cnt}.scn{2}*Hcoef{cnt}.a(2)-Tcoef{cnt}.a(2)*shapeTrue{cnt}(linspace(0,1,LL))/sqrt(sum(abs(shapeTrue{cnt}(linspace(0,1,LL))).^2)/LL))/sqrt(length(shape{cnt}.scn{2}*Hcoef{cnt}.a(2)))
        ...
        norm(shape{cnt}.ssn{2}*Hcoef{cnt}.b(2)-Tcoef{cnt}.b(2)*shapeTrue{cnt}(linspace(0,1,LL))/sqrt(sum(abs(shapeTrue{cnt}(linspace(0,1,LL))).^2)/LL))/sqrt(length(shape{cnt}.ssn{2}*Hcoef{cnt}.b(2)))
    end
    ...
    for i = 1:numGroup
        ...
        b=get(gca);
        set(b.XLabel, 'FontSize', 32);set(b.YLabel, 'FontSize', 32);set(b.ZLabel, 'FontSize', 32);set(b.Title, 'FontSize', 32);
        tit = sprintf('./results/RDSA_fig_cross_%d.fig',i);
        saveas(pic,tit);
        str = sprintf('./results/RDSA_fig_cross_%d',i);
        print(gcf, '-depsc', str);   command = sprintf('epstopdf %s.eps',str);      system(command);
    end
    pic = figure;
    ...
    saveas(pic,'./results/RDSA_fig_cross_checkcomp1.fig');
    set(gca, 'FontSize', 16);
    b=get(gca);
    set(b.XLabel, 'FontSize', 16);set(b.YLabel, 'FontSize', 16);set(b.ZLabel, 'FontSize', 16);set(b.Title, 'FontSize', 16);
    str = './results/RDSA_fig_cross_checkcomp1';
    print(gcf, '-depsc', str);      command = sprintf('epstopdf %s.eps',str);      system(command);
    ...
    xlabel('time');ylabel('signal intensity');legend('Est','True');
    pbaspect([10 1 1]); set(pic, 'Position', [200, 200, 1200, 200]); axis tight;
    saveas(pic,'./results/RDSA_fig_cross_checkcomp2.fig');
    set(gca, 'FontSize', 16);
    b=get(gca);
    set(b.XLabel, 'FontSize', 16);set(b.YLabel, 'FontSize', 16);set(b.ZLabel, 'FontSize', 16);set(b.Title, 'FontSize', 16);
    str = './results/RDSA_fig_cross_checkcomp2';
    print(gcf, '-depsc', str);      command = sprintf('epstopdf %s.eps',str);      system(command);
    ...
    pbaspect([10 1 1]); set(pic, 'Position', [200, 200, 1200, 200]); axis tight;
    saveas(pic,'./results/RDSA_fig_cross_errcomp1.fig');
    set(gca, 'FontSize', 16);
    b=get(gca);
    set(b.XLabel, 'FontSize', 16);set(b.YLabel, 'FontSize', 16);set(b.ZLabel, 'FontSize', 16);set(b.Title, 'FontSize', 16);
    str = './results/RDSA_fig_cross_errcomp1';
    print(gcf, '-depsc', str);      command = sprintf('epstopdf %s.eps',str);      system(command);
    ...
    xlabel('time');ylabel('error');
    pbaspect([10 1 1]); set(pic, 'Position', [200, 200, 1200, 200]); axis tight;
    saveas(pic,'./results/RDSA_fig_cross_errcomp2.fig');
    set(gca, 'FontSize', 16);
    b=get(gca);
    set(b.XLabel, 'FontSize', 16);set(b.YLabel, 'FontSize', 16);set(b.ZLabel, 'FontSize', 16);set(b.Title, 'FontSize', 16);
    str = './results/RDSA_fig_cross_errcomp2';
    print(gcf, '-depsc', str);      command = sprintf('epstopdf %s.eps',str);      system(command);
    
    
    
    pic = figure;axis square;
    h(1) = plot(x,insFreq(1,:),'b','LineWidth',2);
    hold on;
    ...
    b=get(gca);
    set(b.XLabel, 'FontSize', 16);set(b.YLabel, 'FontSize', 16);set(b.ZLabel, 'FontSize', 16);set(b.Title, 'FontSize', 16);
    str = sprintf('./results/RDSA_fig_cross_IF'); saveas(pic,str);
    print(gcf, '-depsc', str);   command = sprintf('epstopdf %s.eps',str);      system(command);
end
